...
Global climate change involves the rising of sea level around the world. This is driven by two primary factors: the thermal expansion of water as it heats up, and the melting of ice at the poles increasing the amount of liquid water in the oceans. The oceans currently rise at a rate of slightly more than three millimeters each year.
    ...
    <p style={{fontSize: 20}}>Although this issue is one of the first that comes to mind when considering the effects of climate change, it is difficult to envision the effects of oceans rising by less than a centimeter each year.</p>
    <hr/>
    <div className="w3-container" id="services" style={{marginTop: 75}}>
        <h1 className="w3-xxxlarge w3-text-blue"><b>The Effects Of Climate Change</b></h1>
        <hr style={{width: 50, border: 5 }} className="w3-round" />
    </div>
    <p style={{fontSize: 20}}>Global climate change has already had observable effects on the environment. Glaciers have shrunk, ice on rivers and lakes is breaking up earlier, plant and animal ranges have shifted and trees are flowering sooner.</p>
     <p style={{fontSize: 20}}>Effects that scientists had predicted in the past would result from global climate change are now occurring: loss of sea ice, accelerated sea level rise and longer, more intense heat waves.</p>
      <p style={{fontSize: 20}}>Scientists have high confidence that global temperatures will continue to rise for decades to come, largely due to greenhouse gases produced by human activities. The Intergovernmental Panel on Climate Change (IPCC), which includes more than 1,300 scientists from the United States and other countries, forecasts a temperature rise of 2.5 to 10 degrees Fahrenheit over the next century.</p>
       <p style={{fontSize: 20}}>According to the IPCC, the extent of climate change effects on individual regions will vary over time and with the ability of different societal and environmental systems to mitigate or adapt to change.</p>
        <p style={{fontSize: 20}}>The IPCC predicts that increases in global mean temperature of less than 1.8 to 5.4 degrees Fahrenheit (1 to 3 degrees Celsius) above 1990 levels will produce beneficial impacts in some regions and harmful ones in others. Net annual costs will increase over time as global temperatures increase.</p>
         <p style={{fontSize: 20}}>"Taken as a whole," the IPCC states, "the range of published evidence indicates that the net damage costs of climate change are likely to be significant and to increase over time." </p>
         <hr/>
         <div className="w3-container" id="services" style={{marginTop: 75}}>
        ...
        <hr style={{width: 50, border: 5 }} className="w3-round" />
         ...
         <p style={{fontSize: 20}}>The rise in sea level is occurred mainly by two factors linked to global warming, i.e the melting of ice sheets as </p>
         <hr/>
         <div className="w3-container" id="services" style={{marginTop: 75}}>
        ...
        <hr style={{width: 50, border: 5 }} className="w3-round" />
               ...
               <p style={{fontSize: 20}}>You already know the causes now it is time to know the effects from rising ocean temperature which you can read below:</p>
               <p style={{fontSize: 20}}>
