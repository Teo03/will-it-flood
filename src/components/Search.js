...
function Search(props) {
  ...
  return (
    <div className='center w3-center'>
      ...
      <div className="w3-center">
      <h1 className="w3-xlarge" style={{padding: 20}}>An informational website regarding the global sea level rise issue.</h1>
      <a href="https://2019.spaceappschallenge.org/challenges/earths-oceans/rising-water/teams/planet-earth-protocol/project"><h1 className="w3-xlarge">Click HERE for more</h1></a>
      <a href="https://2019.spaceappschallenge.org/challenges/earths-oceans/rising-water/teams/planet-earth-protocol/project"><img style={{margin: 20, width: '25%', height: '25%'}} src={nasa} alt="nasa" /></a>
      </div>
    </div>
  );
}
