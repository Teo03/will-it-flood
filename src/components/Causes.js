  ...
  return (
    <div style={{padding: 150, textAlign: "center"}}>
        ...
        <div className="w3-container" id="services" style={{marginTop: 75}}>
            ...
            <p style={{fontSize: 25, padding: 30, margin: -25}}>• Vaporized water. Water vapor increases as the Earth's
        ...
        <div className="w3-container" id="designers" style={{marginTop: 75}}>
            ...
            <p style={{fontSize: 25, padding: 30, margin: -25}}>Nitrous oxide. A powerful greenhouse gas produced by soil
        ...
        <div className="w3-container" id="packages" style={{marginTop: 75}}>
            ...
            <hr style={{width: 50, border: 5 }} className="w3-round" />
            <p style={{fontSize: 25, padding: 30, margin: -25}}>Chlorofluorocarbons (CFCs). Synthetic compounds entirely of
        ...
        <div className="w3-container" id="packages" style={{marginTop: 75}}>
            ...
            <p style={{fontSize: 25, padding: 30, margin: -25}}>
                We all know that the main component of the ocean is the ocean water. The ocean water is a source of life for
                the marine creatures. It also maintains the overall temperature of the earth’s climate. While doing all
                that, the ocean tries very hard to maintain its own water temperature. But can ocean temperature rise? It
                definitely can and we will tell you how. Beside global warming, the changing climate and the greenhouse
                effect, below are a few more causes for the rising of ocean temperatures.
            </p>
            <p style={{fontSize: 25, padding: 30, margin: -25}}>
                1.<b> El Nino</b><br />
                El Nino is a severe climate condition that can potentially increase the ocean water. The temperature of the
                ocean is able to rise up between 3 to 5 degrees when El Nino happens. For more information visit:
